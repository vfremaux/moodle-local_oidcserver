...
class Product_Instance_Form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('textarea', 'productiondata', get_string('productiondata', 'local_shop'), ['cols' => 120, 'rows' => 6]);
        $mform->setType('productiondata', PARAM_TEXT);
        $mform->setAdvanced('productiondata');

        $mform->addElement('textarea', 'extradata', get_string('extradata', 'local_shop'), ['cols' => 120, 'rows' => 6]);
        $mform->setType('extradata', PARAM_TEXT);
        $mform->setAdvanced('extradata');
