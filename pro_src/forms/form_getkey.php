...
class GetKey_Form extends moodleform {
    ...
    public function definition() {
        ...
        if (!empty($options = $this->_customdata['options'])) {
            ...
            $mform->addGroup($group, 'activationoptionarr', get_string('activationoption', 'local_shop'), array(' '), false);
            ...
            $this->add_action_buttons(true, get_string('activate', 'local_shop'));
