...
trait CryptTrait
{
    ...
    protected function encrypt($unencryptedData)
    {
        try {
            ...
            if ($this->encryptionKey instanceof CryptKey) {
                return Crypto::encryptWithPassword($unencryptedData, $this->encryptionKey->getKeyContents());
            }
    ...
    protected function decrypt($encryptedData)
    {
        try {
            ...
            if ($this->encryptionKey instanceof CryptKey) {
                return Crypto::decryptWithPassword($encryptedData, $this->encryptionKey->getKeyContents());
            }
