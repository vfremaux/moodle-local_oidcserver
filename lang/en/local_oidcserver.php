...
$string['altredirecturi'] = 'Alternative redirect uris';
$string['altredirecturi_help'] = 'These URI are expected to be presented in Auth Requests. Server should deny access if an explicit return URI does not match. Comma separated list.';
