...
$string['altredirecturis'] = 'Alternative redirect uris';
$string['altredirecturis_help'] = 'These URI are expected to be presented in Auth Requests. Server should deny access if an explicit return URI does not match. Comma separated list.';
...
$string['configforceopeningcors'] = 'Force opening CORS';
$string['configforceopeningcors_desc'] = 'If enabled, will release the Access-Control-Allow-Origin for the whole moodle';
...
$string['configclientskeysize'] = 'Key size when generatring for client records';
$string['configclientskeysize_desc'] = 'The generated key size (defaults to 13)';
