...
$string['altredirecturi'] = 'URIs de redirection alternatives';
$string['altredirecturi_help'] = 'Ces URIs sont celles qui peuvent être explicitées dans les requêtes d\'authentification. Le serveur doit refuser l\'accès si l\'URI explicite n\'est pas dans la liste (liste à virgules).';
